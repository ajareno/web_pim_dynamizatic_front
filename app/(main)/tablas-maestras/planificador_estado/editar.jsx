...
import { postPlanificadorEstado, patchPlanificadorEstado } from "@/app/api-endpoints/planificador_estado";
import 'primeicons/primeicons.css';
import { getUsuarioSesion } from "@/app/utility/Utils";
import EditarDatosPlanificadorEstado from "./EditarDatosPlanificadorEstado";
import { useIntl } from 'react-intl';
const EditarPlanificadorEstado = ({ idEditar, setIdEditar, rowData, emptyRegistro, setRegistroResult, listaTipoArchivos, seccion, editable }) => {
    const toast = useRef(null);
    const intl = useIntl();
    const [planificadorEstado, setPlanificadorEstado] = useState(emptyRegistro);
    ...
    const validaciones = async () => {
        ...
        const validaNombre = planificadorEstado.nombre === undefined || planificadorEstado.nombre === "";
    ...
    const guardarIncidenciaTipo = async () => {
        ...
        if (await validaciones()) {
            ...
            let objGuardar = { ...planificadorEstado };
            ...
            if (idEditar === 0) {
                ...
                objGuardar['empresaId'] = getUsuarioSesion()?.empresaId;
                await patchPlanificadorEstado(objGuardar.id, objGuardar);
                setIdEditar(null)
            ...
            <div className="grid Empresa">
                <div className="col-12">
                    <div className="card">
                        ...
                        <h2>{header} {(intl.formatMessage({ id: 'Estado del planificador' })).toLowerCase()}</h2>
